package com.realEstate.realEstate.util.oauth;
...
import com.realEstate.realEstate.model.security.CustomOAuth2User;
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        try {
            ...
            if(oAuth2User.getRole() == UserRole.GUEST) {
                String accessToken = jwtService.createAccessToken(authentication.getName(), secretKey, expiredTimeMs);
...
//                findUser.authorizeUser();
    ...
    private void loginSuccess(HttpServletResponse response, CustomOAuth2User oAuth2User) throws IOException {
        String accessToken = jwtService.createAccessToken(oAuth2User.getName(), secretKey, expiredTimeMs);
