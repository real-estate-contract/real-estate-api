...
public class PropertyService {
    ...
    @Transactional
    // Create
    public Long create(int weeklyFee, boolean deposit, int depositFee, int minimum,boolean washingmachine, boolean airconditioner,
                       boolean refrigerator, int price, boolean management, int managementFee, int wholeFloor, int floor,
                       boolean parkingAvailable,  LocalDate startDate,LocalDate endDate, Structure structure,boolean usageFee,
                       boolean negotiationFee, boolean loanFund, int roomCount, int bathroomCount, int area1, int area2,
                       Long addressId, String userName) {
...
//        redisRepository.setProperty(Property.of(transactionType, price, deposit, monthlyRent,management, managementFee, condominium, area, wholeFloor, floor, parkingAvailable, hasElevator,moveInDate,structure,direction, usageFee, negotiationFee, loanFund, year, generationCount,address, user));
        ...
        Property property  = propertyRepository.save(Property.of(weeklyFee, deposit, depositFee, price, management,
                managementFee,wholeFloor, floor, parkingAvailable, startDate,endDate,minimum, structure, usageFee, negotiationFee,
                loanFund, roomCount, bathroomCount, area1, area2, washingmachine, airconditioner, refrigerator, address, user));
